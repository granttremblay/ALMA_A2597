...
### G. Tremblay, grant.tremblay@yale.edu
### This basic script was used to image measurement sets for Tremblay+2016, Nature
### You first need to create calibrated measurement sets using reduction_script.py

import os

##### Change this stuff ######################
velres = 40 #Velocity resolution / channel width in km/sec
